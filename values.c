...
int initValues()
{
	...
	if (fullKeyboard == K_NO) {
		...
		static int64_t costsCopy[KSIZE_MAX] = {
            // 24 keys LaSalle, based on modified BEAKL weigths
            999, 999, 220, 200, 999, 999,   999, 999, 200, 220, 999, 999, 
            999, 999, 0,   0 ,  100, 999,   999, 100, 0  , 0,   999, 999, 
            999, 90 , 50,  50 , 0 ,  110,   100, 0 ,  50 , 50,  90,  999, 
            999, 999, 230, 220, 80,  140,   135, 80,  220, 230, 999, 999, 
            //  thumbs !? only really have one : spacebar ..
            999, 999, 999, 999, 999, 999,   999, 999, 999, 999, 999, 999,   
            999, 999, 999, 999, 999, 999,   999, 999, 999, 999, 999, 100, 
/*
            // 24 keys LaSalle, based on modified BEAKL weigths
            999, 999, 200, 180, 999, 999,   999, 999, 180, 200, 999, 999, 
            999, 999, 0,   0 ,  100, 999,   999, 100, 0  , 0,   999, 999, 
            999, 90 , 50,  50 , 0 ,  110,   100, 0 ,  50 , 50,  90,  999, 
            999, 999, 220, 220, 80,  140,   135, 80,  220, 220, 999, 999, 
            //  thumbs !? only really have one : spacebar ..
            999, 999, 999, 999, 999, 999,   999, 999, 999, 999, 999, 999,   
            999, 999, 999, 999, 999, 999,   999, 999, 999, 999, 999, 100, 
*/
		...
		*/
		...
		static int64_t costsCopy[KSIZE_MAX] = {
		    ...
		    // 999, 0 ,  0  ,100, 999,  999,100, 0  , 0 ,  999,
		    // 90 , 50,  50 , 0 , 110,  100, 0  ,50 , 50,  90,
		    // 180, 220, 220, 80, 165,  165, 80, 220, 220, 180

		    // 999, 15,  0  ,100, 999,  999,100, 0  , 15,  999,
		    // 90 , 50,  50 , 10, 110,  100, 10 ,50 , 50,  90,
		    // 180, 220, 220, 80, 165,  165, 80, 220, 220, 180

		    // 999, 0 ,  0  ,100, 999,  999,100, 0  , 0 ,  999,
		    // 90 , 50,  50 , 0 , 110,  100, 0  ,50 , 50,  90,
		    // 180, 220, 220, 80, 999,  999, 80, 220, 220, 180

			// 999, 0 ,  0  , 80, 999,  999, 80, 0  , 0 ,  999,
			// 90 , 50,  50 , 0 , 90 ,  90 , 0 , 50 , 50,  90,
			// 180, 220, 210, 80, 999,  999, 80, 210, 220, 180
